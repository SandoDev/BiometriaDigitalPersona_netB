 ...
 *
 * @author Pen-SandO
 * para el uso correcto de este programa es necesario la libreia json-simple-1.1.1.jar
 */
public class JavaYphpYmysql {

    /**
     * @param args the command line arguments
     */
    private static final String USER_AGENT = "Mozilla/5.0";
    private static final String SERVER_PATH = "http://localhost/BiometriaDigitalPerson/scrips/";

    static String nombre = "sanchez";
    static String apellidos = "broda";
